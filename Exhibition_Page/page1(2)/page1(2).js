...
function openPuzzle1(){
    window.open("../page1/puzzle/puzzle1.html","Study","width=1270px, height=500px");
}
function openPuzzle2(){
    window.open("../page1/puzzle/puzzle2.html","Love","width=1270px, height=500px");
}
function openPuzzle3(){
    window.open("../page1/puzzle/puzzle3.html","Study","width=1270px, height=500px");
}
function openPuzzle4(){
    window.open("../page1/puzzle/puzzle4.html","Healing","width=1270px, height=500px");
}